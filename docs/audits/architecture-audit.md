...
## 2026-08-11 T14 shared browser Socket.IO lifecycle architecture re-audit — superseded by T14-S13
...
runtime API, schema, or persistence authority. The Roadmap owns the next exact continuation gate
after the affected profile chain revalidates; none of
