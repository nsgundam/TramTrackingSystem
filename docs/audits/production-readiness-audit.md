...
| D-001=C public rider service | No-Go | Bounded truthful and scoped keyboard-accessible journeys exist, but all internal gates plus contrast/assistive-technology/human/deployed recovery evidence and release approval remain absent. |
