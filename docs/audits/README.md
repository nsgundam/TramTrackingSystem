...
| Dashboard & UX | Needs Re-audit | `docs/audits/dashboard-ux-audit.md` | `b3682fc` | 2026-07-19 | Eligible after current Product, Frontend, and Infrastructure & Device reports; revalidate rider/admin truthfulness and research separation. |
