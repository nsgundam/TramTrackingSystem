...
| Architecture | Needs Re-audit | `docs/audits/architecture-audit.md` | `f0bd2e7` | 2026-07-22 | T6 changes the canonical Redis state authority, publication ordering, freshness transitions, and route authority. Re-audit after T6 runtime evidence; task `T6`. |
| Backend | Needs Re-audit | `docs/audits/backend-audit.md` | `565c58c` | 2026-07-22 | T6 changes ingest/realtime/public canonical boundaries and source-health publication. Re-audit after disposable runtime checks; task `T6`. |
| Frontend | Needs Re-audit | `docs/audits/frontend-audit.md` | `e566cca` | 2026-07-22 | T6 changes public/admin realtime consumers, initial snapshot hydration, ordering, route authority, and stale states. Re-audit after browser/runtime evidence; task `T6`. |
...
| Production Readiness | Needs Re-audit | `docs/audits/production-readiness-audit.md` | current baseline `847a18c` | 2026-07-22 | T6 changes production-readiness evidence for canonical truth, stale/no-service behavior, reconnect handling, and runtime validation. Re-audit after T6 disposable/runtime evidence; task `T6`. |
