...
| Roadmap | Complete / Validated | `docs/roadmap/master-refactoring-roadmap.md` | `70f42c1` | 2026-08-11 | First eleven T14 slices are accepted; exact visible OSM attribution/official Standard raster endpoint alignment handoff is next. |
