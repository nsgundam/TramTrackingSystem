...
| Architecture | Complete | `docs/audits/architecture-audit.md` | `f0bd2e7` | 2026-07-22 | Validated at baseline `847a18cce9bc27c82b2622dbc176b3a89bc4d037` with Discovery and Product predecessors; Backend, Frontend, and Database are next eligible in parallel. |
...
| Infrastructure & Device | Needs Re-audit | `docs/audits/infrastructure-device-audit.md` | `565c58c` | 2026-07-22 | Legacy report lacks complete predecessor-baseline metadata. |
| Dashboard & UX | Needs Re-audit | `docs/audits/dashboard-ux-audit.md` | `b3682fc` | 2026-07-19 | Legacy report lacks baseline/predecessor metadata. |
| Security, DevOps & Observability | Needs Re-audit | `docs/audits/security-devops-observability-audit.md` | `565c58c` | 2026-07-22 | Legacy report lacks complete predecessor-baseline metadata. |
