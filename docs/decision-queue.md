...
retention, one-way receipt, and staff-triage policy. The existing nullable `vehicleId` model can
represent the simple variant, but `null` cannot distinguish explicit system Feedback from an
