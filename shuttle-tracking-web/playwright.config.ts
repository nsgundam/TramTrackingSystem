...
export default defineConfig({
  testDir: "./tests",
  testMatch: ["t8-route-switch.spec.ts", "t14-truthful-state.spec.ts", "t14-accessibility.spec.ts", "t14-map-quality.spec.ts", "t14-contrast.spec.ts", "t14-admin-dashboard.spec.ts", "t14-public-service-explanation.spec.ts"],
  timeout: 30_000,
